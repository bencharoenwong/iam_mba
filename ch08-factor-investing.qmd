---
abstract: "Moving beyond simple market exposure, this chapter introduces factor investing as a systematic framework for decomposing and harvesting returns through known drivers like value, momentum, and quality. It provides practical guidance on reading regression output to identify true alpha versus compensated risk, while addressing the costs and mechanics of leveraged ETFs."
keywords: ["Factor Investing", "Regression Analysis", "Leveraged ETFs", "Risk Premia", "Smart Beta", "Systematic Investing"]
---

# Session 08: Factor Investing — Systematic Approaches to Investments

## Guiding Questions
- What explains the persistence of factor premiums?
- How should investors combine multiple factors in portfolios?
- What are the main implementation challenges in factor investing?
- How can investment jargon and complex fee structures be used to exploit rather than inform clients?

::: {.content-visible when-profile="course"}
::: {.callout-important}
## LiveCase Assignment
Following this session, you will complete **LiveCase Episode 2**, which demonstrates how factor investing terminology and fee structures can be used to obscure rather than clarify, putting Sharpe's arithmetic of active management into stark relief.
:::
:::

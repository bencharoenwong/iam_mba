---
abstract: "This chapter defines what it takes to find a genuine investment edge in an increasingly commoditized market, categorizing edges into informational, analytical, infrastructural, and access-based. It explores the Grossman-Stiglitz paradox to explain why markets must remain slightly inefficient to reward information collection, setting a high bar for claiming true manager skill."
keywords: ["Investment Edge", "Grossman-Stiglitz Paradox", "Alpha Generation", "Manager Selection", "Market Inefficiency", "Active Strategies"]
---

# Session 09: Active Management Strategies & Evaluation

## Guiding Questions
- How do successful active managers create persistent value?
- What role does investment process play in active management?
- How should investors evaluate active managers beyond performance?
- What are the scalability challenges in active management?
